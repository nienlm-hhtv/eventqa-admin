...
public class Result2 {
    ...
    public Result2(String status, boolean success, String message, String id, String name, String description, String imageLink, String qrCodeLink, String creator_id, String creator_name, String create_at, int total_question, int answered_question) {
        this.status = status;
        this.success = success;
        this.message = message;
        this.id = id;
